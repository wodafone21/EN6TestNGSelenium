...
public class AttributeTest {
    ...
    public void test1 () {
        ...
        //get the value of "checked" attribute: since checked attribute does not keep any value, it will return true or false depends
        System.out.println(blueRadioBtn.getAttribute("checked"));

        //trying to get attribute that does not exist: return null
